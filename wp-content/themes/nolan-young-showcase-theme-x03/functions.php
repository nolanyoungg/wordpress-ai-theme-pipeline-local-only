...
function nolan_young_showcase_setup() {
    ...
    register_nav_menus(array(
        ...
        'primary' => esc_html__('Primary Menu', 'nolan-young-showcase-theme-x02'),


        'footer'  => esc_html__('Footer Menu', 'nolan-young-showcase-theme-x02'),
    ...
    register_sidebar(array(
        ...
        'name'          => esc_html__('Sidebar', 'nolan-young-showcase-theme-x02'),


        'id'            => 'sidebar-1',


        'description'   => esc_html__('Add widgets here.', 'nolan-young-showcase-theme-x02'),
